package com.example.inventory.utils.security;

import com.example.inventory.utils.filter.*;
  ...
  private final UserDetailsService userDetailsService;
   private final BCryptPasswordEncoder bCryptPasswordEncoder;
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers(DELETE,"/api/user/{id}/**").hasAnyAuthority("ROLE_SUPER_ADMIN");
